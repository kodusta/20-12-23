                                ...
                                <div className="row">
                                    ...
                                    <div className="col-xl-4 col-custom-xl-6 col-lg-6">
                                        <div className="footer-widget footer-widget--two">
                                            ...
                                            <p className="footer-widget__text">Join our community and be the first to
                                                know about offers, new collections and interior trends.</p>
                                        ...
                                        <div className="footer-widget footer-widget--two">
                                            <span
                                                className="footer-widget__text footer-widget__text--two">Follow us</span>
                                            <ul className="footer-widget__social-links">
                                                <li><a href="/" title="Facebook"><i className="fa fa-facebook"/></a>
                                                </li>
                                                <li><a href="/" title="Twitter"><i className="fa fa-twitter"/></a></li>
                                                <li><a href="/" title="LinkedIn"><i className="fa fa-linkedin"/></a>
                                                </li>
                                                <li><a href="/" title="LinkedIn"><i className="fa fa-instagram"/></a>
                                                </li>
                                                <li><a href="/" title="Youtube"><i className="fa fa-youtube-play"/></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="footer-payment-logo">
                                            <img src={process.env.PUBLIC_URL + "/img/icons/payments.png"}
                                ...
                                <nav className="offcanvas-naviagtion">
                                    <ul>
                                        ...
                                        <li className="menu-item-has-children"><a href="/">Elements</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item-has-children"><a href="/">Shop/Products</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="element-product-category.html">Product
                                                            Categories</a></li>
                                                        <li><a href="element-product-carousel.html">Products
                                                            Carousel</a></li>
                                                        <li><a href="element-product-widget.html">Product Widget</a>
                                                        </li>
                                                        <li><a href="element-recent-product.html">Recent Products</a>
                                                        </li>
                                                        <li><a href="element-sale-product.html">Sale Products</a></li>
                                                        <li><a href="element-featured-product.html">Featured Product</a>
                                                        </li>
                                                        <li><a href="element-top-rated-product.html">Top Rated
                                                            Products</a></li>
                                                    </ul>
                                                </li>
                                                <li className="menu-item-has-children"><a href="/">Theming</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="element-blog-post.html">Blog Posts</a></li>
                                                        <li><a href="element-mailchimp-form.html">MailChimp Form</a>
                                                        </li>
                                                        <li><a
                                                            href="element-accordion-toggles.html">Accordion/Toggles</a>
                                                        </li>
                                                        <li><a href="element-progress-bar.html">Progress Bars</a></li>
                                                        <li><a href="element-countdown-timer.html">Countdown Timer</a>
                                                        </li>
                                        ...
                                        <li className="menu-item-has-children"><a href="/">Blog</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item-has-children"><a href="/">Blog post list</a>
                                                    <ul className="sub-menu">
                                                ...
                                                <li className="menu-item-has-children"><a href="/">Blog post details</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="blog-post-format-image.html">Blog post format
                                                            image</a></li>
                                                        <li><a href="blog-post-format-gallery.html">Blog post format
                                                            gallery</a></li>
                                                        <li><a href="blog-post-format-audio.html">Blog post format
                                                            audio</a></li>
                                                        <li><a href="blog-post-format-video.html">Blog post format
                                                            video</a></li>
                                                        <li><a href="blog-post-left-sidebar.html">Blog post left
                                                            sidebar</a></li>
                                        ...
                                        <li className="menu-item-has-children"><a href="/">Shop</a>
                                            <ul className="sub-menu">
                                                <li className="menu-item-has-children"><a href="/">Shop Pages</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="shop-fullwidth.html">Shop Fullwidth</a></li>
                                                        <li><a href="shop-list.html">Shop List Layout</a></li>
                                                        <li><a href="shop-no-sidebar.html">Shop No Sidebar</a></li>
                                                        <li><a href="shop-left-sidebar.html">Shop With Left Sidebar</a>
                                                        </li>
                                                        <li><a href="shop-right-sidebar.html">Shop With Right
                                                            Sidebar</a></li>
                                                        <li><a href="shop-brand.html">Shop By Brand</a></li>
                                                    </ul>
                                                </li>
                                                <li className="menu-item-has-children"><a href="/">Shop
                                                    Pages(Details)</a>
                                                    <ul className="sub-menu">
                                                        <li><a href="product-details-basic.html">Basic</a></li>
                                                        <li><a href="product-details-fullwidth.html">Fullwidth</a></li>
                                                        <li><a href="product-details-sticky.html">Sticky Details</a>
                                                        </li>
                                                        <li><a href="product-details-bottom-thumbnail.html">Bottom
                                                            thumbnails</a></li>
                                                        <li><a href="product-details-extra-content.html">Extra
                                                            content</a></li>
                                                        <li><a href="product-details-variation-image.html">Variations
                                                            Images</a></li>
                                    ...
                                    <div className="off-canvas-contact-widget">
                                        <div className="header-contact-info">
                                            <ul className="header-contact-info__list">
                                                <li><i className="pe-7s-phone"/> <a href="tel://12452456012">(1245) 2456
                                                    012 </a></li>
                                                <li><i className="pe-7s-mail-open"/> <a
                    ...
                    <div id="qv-1" className="cd-quick-view">
                        <div className="cd-slider-wrapper">
                            ...
                            <ul className="cd-slider">
                                <li className="selected"><img
                                    src={process.env.PUBLIC_URL + "/img/products/product-9-1-600x800.jpg"}
                                    alt="Product 2"/></li>
                                <li><img src={process.env.PUBLIC_URL + "/img/products/product-9-2-600x800.jpg"}
                                         alt="Product 1"/></li>
                            </ul>
                            ...
                            <ul className="cd-slider-navigation">
                                <li><a className="cd-prev" href="#0"><i className="fa fa-angle-left"/></a></li>
                                <li><a className="cd-next" href="#0"><i className="fa fa-angle-right"/></a></li>
                            </ul>
                        </div>
                        <div className="quickview-item-info cd-item-info ps-scroll">
                            ...
                            <p className="description">Upholstered velvet ottoman with antique stud detailing. Invite
                                restrained glamour and on-trend colour into your design scheme with the Eichholtz Ponti
                                Ottoman. Inspired by the neo-classical influences of Italian icon, Gio Ponti, this
                                contemporary ottoman collection is presented in a choice of velvet and linen
                                colourways.</p>
                            ...
                            <div className="quick-view-other-info">
                                <div className="other-info-links">
                                    <a href="/"><i className="fa fa-heart-o"/> ADD TO WISHLIST</a>
                                    <a href="/"><i className="fa fa-exchange"/> COMPARE</a>
                                </div>
                                <table>
                                    <tbody>
